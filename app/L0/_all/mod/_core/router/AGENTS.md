...
- the router shell does not provide shared route content padding or shared route-end overscroll; routed pages must own their own vertical spacing, local card padding, and any extra bottom breathing room they need under the onscreen chat overlay
