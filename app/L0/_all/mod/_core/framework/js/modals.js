...
import { callJsExtensions } from "./extensions.js";
import { applyModuleResolution } from "./moduleResolution.js";
...
export async function openModal(modalPath, beforeClose = null) {
  ...
  return new Promise((resolve) => {
    try {
      ...
      const componentPath = applyModuleResolution(modalPath); // `modals/${modalPath}/modal.html`;
