...
function resolveRootPageResourceRequest(pagesDir, pathname) {
  ...
  return {
    ...
    kind: "resource",
    serviceWorkerAllowed: normalizedPath === "/sw.js" ? "/" : undefined
  };
}
...
async function handlePageRequest(res, requestUrl, options = {}) {
  ...
  if (resourceRequest) {
    ...
    const swHeader = resourceRequest.serviceWorkerAllowed
      ? { "Service-Worker-Allowed": resourceRequest.serviceWorkerAllowed }
      : {};
